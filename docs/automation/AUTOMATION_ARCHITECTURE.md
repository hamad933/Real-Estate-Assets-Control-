...
Current limitation: idempotency markers are retained as GitHub Actions artifacts with bounded retention. This is fail-closed within the retained evidence horizon but is not yet a permanent authority ledger. Trusted publication and live Provider canaries remain separately gated.
