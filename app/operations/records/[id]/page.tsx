...
export default async function OperationsRecordPage({
  ...
  return (
    <WorkspaceShell
      ...
      eyebrow="سجل تشغيلي"
      title="فهرس السجل التشغيلي"
      description="نقطة انتقال واحدة بين السجلات التشغيلية المترابطة لهذا الأصل والوحدة، مع تطبيق فحص النطاق قبل العرض."
    >
      <section className={styles.heroStateGood} aria-labelledby="record-scope-title">
        ...
        <div>
          <p className={styles.kicker}>حالة الوصول</p>
          <h2 id="record-scope-title">ضمن النطاق</h2>
          <p>تم السماح بعرض هذا السجل لأن معرّفه موجود ضمن نطاق جلسة العمليات الحالية.</p>
        </div>
      ...
      <section className={styles.panel} aria-labelledby="record-index-title">
        <div className={styles.panelTitle}>
          <h2 id="record-index-title">السجلات المتاحة</h2>
          <span>بيانات تركيبية ثابتة</span>
        </div>
        ...
        <p className="policy-note">
          هذا الفهرس لا يمنح صلاحيات جديدة؛ جميع الصفحات التابعة تعيد تنفيذ فحص `operations-record` نفسه.
        </p>
      </section>
